...
public class ColorPickerUnityUI : MonoBehaviour , IDragHandler, IPointerDownHandler
{
	...
	private void UpdateThumbPosition()
	{
		...
		if (circular && colorPalette.GetComponent<CircleCollider2D>())
		{
			...
			Vector3 Set = Vector3.ClampMagnitude(offset,
				(colorPalette.GetComponent<CircleCollider2D>().radius * myScale.transform.localScale.x));
    ...
    public void OnDrag(PointerEventData eventData)
	{
		...
		FindObjectOfType<DrawOrShot>().brushColor = value;
	}
