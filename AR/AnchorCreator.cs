...
public class AnchorCreator : MonoBehaviour
{
    ...
    public void Plane_Update()
    {
        ...
        if (m_RaycastManager.Raycast(/*touch.position*/new Vector2(Screen.width/2,Screen.height/2), s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            m_AnchorPrefab.transform.position = pos;
            CompassTest.heights = hitPose.position.y;
            myHeight = hitPose.position.y;
